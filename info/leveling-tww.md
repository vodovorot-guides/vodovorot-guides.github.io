...
5. Дополнительный лут с [Отреставрированным ключем от сундука](https://www.wowhead.com/ru/item=224172) доступен только в вылазках, отмеченных на карте как "Многообещающая вылазка". По текущей информации будет доступно **четыре** таких вылазки в день, по одной в каждой зоне.
