...
* В патчноутах также указано, что был удален [Ледяной шок](https://www.wowhead.com/ru/spell=196840), при этом по факту он всё еще остался в древе талантов.
...
[Ветра Ал'акира](https://www.wowhead.com/beta/spell=382215/) был переработан – теперь пассивно увеличивает скорость передвижания на **5%** и еще дополнительно на **5%** во время действия [Призрачного волка](https://www.wowhead.com/ru/spell=2645).
{: class="bordered"}

* Данный талант больше не имеет привязки к количеству установленных тотемов и в целом стал гораздо лучше.

<hr style="height:1px;background-color:#bbb">
<p></p>

[Гнев природы](https://www.wowhead.com/beta/spell=381655/) – теперь увеличивает шанс критических заклинаний школы магии природы на **2%** вместо **4%**, но в него можно вложить два очка.
{: class="bordered"}

* Данное изменение по сути увеличит количество потраченных очков талантов, потому что мы всё равно будем брать этот талант.
...
* Данный талант не просто пассивно увеличивает весь наносимый урон и исцеление, но также добавляет приятное [QoL](https://en.wikipedia.org/wiki/Glossary_of_video_game_terms#QoL) изменение, уменьшающее количество кнопок для ребаффа.
* Работает только с изученными усилениями на оружие, тоесть [Оружие неистовства ветра](https://www.wowhead.com/beta/spell=33757/), [Оружие языка пламени](https://www.wowhead.com/beta/spell=318038/) и [Оружие жизни земли](https://www.wowhead.com/beta/spell=382021/).
* У Элема, без взятого таланта [Оружие языка пламени](https://www.wowhead.com/beta/spell=318038), нет этой способности, а значит масло на оружие не будет сбиваться от использования [Щита молний](https://www.wowhead.com/beta/spell=192106).
...
* Долгожданное изменение, которое напрашивалось для специализации Элема уже долгие годы.
...
* Часть урона, убранного из [Перерождения](https://www.wowhead.com/beta/spell=114050), было перенесено в наши высшие таланты.
...
[Единство со стихиями](https://www.wowhead.com/beta/spell=462866/) – теперь увеличивает урон от соответствующих сил прироны на **6%** вместо **10%**.
{: class="bordered"}
...
Новый талант: [Call of Fire](https://www.wowhead.com/beta/spell=1258899/) – активация [Перерождения](https://www.wowhead.com/beta/spell=114050) призывает [Элементаля огня](https://www.wowhead.com/beta/spell=198067).
{: class="bordered"}
...
Новый талант: [Molten Wrath](https://www.wowhead.com/beta/spell=1258843) – [Выброс лавы](https://www.wowhead.com/beta/spell=51505) теперь наносит на **20%** больше урона. Выбор в одном слоте с [Властелином стихий](https://www.wowhead.com/ru/spell=16166).
{: class="bordered"}
...
* В теории это может быть сильным талантом для огненного билда, но для этого сначала нужно повысить базовый урон [Огненного шока](https://ru.wowhead.com/spell=188389).
...
* Не самый сильный талант, так как мы врядли будем стакать больше **3-4** предка за раз, даже с учетом их увеличенной длительности.

<hr style="height:1px;background-color:#bbb">
<p></p>


Новый талант: [Windspeaker](https://www.wowhead.com/beta/spell=1270447) – снижает время произнесения [Выброса лавы](https://www.wowhead.com/beta/spell=51505), [Исцелящего всплеска](https://www.wowhead.com/beta/spell=8004/) и [Цепного исцеления](https://www.wowhead.com/beta/spell=1064) на **10%**.
{: class="bordered"}
...
Пока не ясна судьба [Грозового разрядника](https://www.wowhead.com/beta/spell=210689/), так как для его полноценной реализации требуется постоянно менять цели на АоЕ, что довольно неудобно для новичков и будет еще менее удобно из-за ограничения работы аддонов в Midnight. Больше не получится раскрашивать неймплейты врагов в различные цвета в зависимости от дебаффов и придется слелдить за [Грозовыми разрядниками](https://www.wowhead.com/beta/spell=210689/) по иконке. В идеале этот дебафф стоит изменить так, чтобы он раскидывался как у Энха, то есть автоматически кидался на соседнюю цель, если он есть на текущей.
...
2. [Хранитель бурь](https://www.wowhead.com/ru/spell=191634) – дополнительный бурст. Его кулдаун разнится в зависимости от героических веток, и на него завязано множество других способностей.
...
[Цепное исцеление](https://www.wowhead.com/beta/spell=1064) – базовое время произнесения составляет **2** секунды вместо **2.5** секунд. Радиус перескока увеличен с **15** метров до **20** метров. Исцеление повышено на **20%**. Стоимость маны снижена на **10%**.
{: class="bordered"}
...
* Отличное изменение для Рестор шамана, который и так собирает критический удар.
...
Новый талант: [Windspeaker](https://www.wowhead.com/beta/spell=1270447) – снижает время произнесения [Волны исцеления](https://www.wowhead.com/beta/spell=77472) и [Цепного исцеления](https://www.wowhead.com/beta/spell=1064) и [Выброса лавы](https://www.wowhead.com/beta/spell=51505),  на **10%**.
{: class="bordered"}
...
* Допольно приятный эффект, который был перенесен из сетового комплекта третьего сезона, [Вой направленной ярости](https://www.wowhead.com/ru/item-set=1929/).
...
Новый талант: [Primal Catalyst](https://www.wowhead.com/beta/spell=1260874/primal-catalyst?spellModifier=137039) – [Тотем исцеляющего потока](https://www.wowhead.com/beta/spell=5394) и [Stormstream Totem](https://www.wowhead.com/beta/spell=1267016/) имеют **20%** при исцелении союзника наложить на него эффект [Оружия жизни земли](https://www.wowhead.com/beta/spell=382021/).
{: class="bordered"}
...
* Его время восстановления равняется времени действия, если взят талант [Сила тотемов](https://www.wowhead.com/beta/spell=381867/).
