...
* Данный талант теперь требует на одно очко талантов больше, но скорость восстанвления [Реинкарнации](https://www.wowhead.com/beta/spell=20608/) была повышена с **75%** до **100%**.
...
[Ветра Ал'акира](https://www.wowhead.com/beta/spell=382215/) был переработан – теперь можно вложить два очка талантов. Пассивно увеличивает скорость передвижения на **3%/6%** и еще дополнительно на **5%/10%** во время действия [Призрачного волка](https://www.wowhead.com/ru/spell=2645).
{: class="bordered"}
...
[Стойкость Теразан](https://www.wowhead.com/beta/spell=1217622/) и [Реагирующий барьер](https://www.wowhead.com/beta/spell=462454/) – теперь являются талантами классовой ветки в одной ячейке выбора, а не в ветке Рестор Шамана.
{: class="bordered"}

* Отличное изменение как для Элема и Энха, так и для Рестора.
...
Сетовый комплект первого сезона Midnight усиливает [Хранитель бурь](https://www.wowhead.com/ru/spell=191634), увеличивая урон от него, скорость после его активации и давая ему дополнительный заряд, но при этом мы скорее всего лишимся одного заряда в базовой способности. Это очень сомнительное решение, отнимать что-то у способности чтобы вернуть это в качестве сетового бонуса, так что будем надеяться что это временное решение и оно изменится ближе к релизу.
...
*Мы по прежнему хотим, чтобы обычные заклинания имели вес, но возможность реагировать на ситуацию с коротким временем восстановления делает игру более интересной и вознаграждающей.*
...
* Данная способность изначально была удалена, но потом её вернули и переработали.
* Сейчас она будет использоваться как мини-кулдаун, излечивая одного союзника и усиливая следующее заклинание.
* [Высвободить чары жизни](https://www.wowhead.com/beta/spell=73685/) больше не усиливает [Целительный ливень](https://www.wowhead.com/beta/spell=73920/) и [Ливневый дождь](https://www.wowhead.com/beta/spell=462486).
...
Все исцеление повышено на **15%**. Исцеление [Быстрины](https://www.wowhead.com/beta/spell=61295), [Волны исцеления](https://www.wowhead.com/beta/spell=77472) и [Цепного исцеления](https://www.wowhead.com/beta/spell=1064) дополнительно повышено на **12%**.
{: class="bordered"}
...
[Пронизывающий ветер](https://www.wowhead.com/beta/spell=57994) – теперь имеет время восстановления **30** секунд.
{: class="bordered"}

* Все остальные лечащие специализации лишились своих прерывающих способностей и она осталась только у Рестора.
* Большой пост разработчиков про это изменение можно найти [по этой ссылке](https://us.forums.blizzard.com/en/wow/t/updates-to-healer-specializations-in-midnight/2189090).
...
[Зов предков](https://www.wowhead.com/beta/spell=443450) – теперь срабатывает от применения [Высвободить чары жизни](https://www.wowhead.com/beta/spell=73685/).
{: class="bordered"}
...
[Пульсирующий тотем](https://www.wowhead.com/beta/spell=444995/) – теперь длится **25** секунд вместо **24** секунд. Время восстановления составляет **25** секунд.
{: class="bordered"}

* [Сила тотемов](https://www.wowhead.com/beta/spell=381867/) больше не работает на этот талант, но его время восстановления было снижено на соответствующее значение.
...
* [2 части](https://www.wowhead.com/beta/spell=1264862): снижает время восстановления [Высвободить чары жизни](https://www.wowhead.com/beta/spell=73685/) на **3** секунды и увеличивает его первоначальное исцеление на **100%**.

* [4 части](https://www.wowhead.com/beta/spell=1264863):  [Высвободить чары жизни](https://www.wowhead.com/beta/spell=73685/) теперь работает на **2** заклинания.
...
Сейчас видно общее направление Рестор шамана в Midnight – у нас будет ощутимо меньше кнопок и временных баффов, которые усиливают определенные заклинания и, которые приходилось стакать для того, чтобы они дали должное количество исцеления. 

При этом талант [Высвободить чары жизни](https://www.wowhead.com/beta/spell=73685/) был сначала удален, но после его вернули и переработали, плюс на него также работает сетовый комплект первого сезона Midnight.

Удаление [Тотема разразившегося ливня](https://www.wowhead.com/ru/spell=157153/) облегчит данный спек для многих игроков, но при этом потеряется глубина – больше не получится накопить в него исцеление перед большим получением урона для эффективного взрыва.
