...
* Макрос на все способности ковенантов. Можно добавить дополнительные условия, например `[@mouseover]`. Если не хватает символов, можно удалить неиспользуемую способность:
~~~
#showtooltip
/cast Тотем вечернего колокола
/cast Цепная жатва
/cast Первозданная волна
/cast Волшебное переливание
/run local G=GetSpellInfo SetMacroSpell(GetRunningMacro(), G"Тотем вечернего колокола" or G"Цепная жатва" or G"Первозданная волна"or G"Волшебное переливание")
~~~
