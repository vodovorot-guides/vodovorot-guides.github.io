...
* Использование всех необходимых баффов на одной кнопке, в зависимости от взятых талантов:
~~~
#showtooltip
...
* [Природная стремительность](https://ru.wowhead.com/spell=378081) и [Молния](https://ru.wowhead.com/spell=188196) на одной кнопке:
~~~
#showtooltip
...
* Применение основной способности [Элементаля бури](https://www.wowhead.com/ru/spell=192249) на тот случай, если он не скастовал её самостоятельно:
~~~
#showtooltip
/cast Неистовство бури
~~~
...
~~~
#showtooltip
/castsequence [@player] reset=3 Небесная ярость, Оружие неистовства ветра, Оружие языка пламени, Щит молний
~~~
