...
* Энх и Рестор могут получить его эффект за счет [Элементаля земли](https://www.wowhead.com/ru/spell=198103) раз в **5** минут в течение **1** минуты, а Элем – гораздо чаще, за счет [Элементаля огня](https://www.wowhead.com/ru/spell=198067) или [Элементаля бури](https://www.wowhead.com/ru/spell=192249).
...
* Талант [Jet Stream](https://www.wowhead.com/ru/spell=462817/) по сути является новым уникальным рейдовым утилити, работающим как массовая [Благословенная свобода](https://www.wowhead.com/ru/spell=1044/), но снимающая только замедления, но не все виды рутов.
...
* Пока не ясно, активируют ли эти мини-элементали талант [Первозданная связь](https://www.wowhead.com/ru/spell=381764), так как на данный момент на бете они не вызываются.
...
[Поток силы](https://www.wowhead.com/ru/spell=385923) – больше не увеличивает генерацию энергиии Водоворота от проков перегрузки.
{: class="bordered"}
...
* Данное изменение позволит не терять урон при использовании вспомогательных способностей, а получать за них столько же энергии Водоворота, как за один [Выброс лавы](https://www.wowhead.com/ru/spell=51505/) без прока Перегрузки.
...
[Властелин стихий](https://www.wowhead.com/ru/spell=16166/) – Теперь увеличивает урон следующего заклинания на **15%** вместо **10%/20%**.
{: class="bordered"}
...
* Вместе с этим изменением был также исправлен баг, который позволял призывать сразу несколько [Предков](https://www.wowhead.com/ru/spell=443450) после [Первозданной волны](https://www.wowhead.com/ru/spell=375982) под действием [Пульсации](https://www.wowhead.com/ru/spell=200071).
...
Рестор шаман получил множество изменений талантов, а также перераспределение талантов внутри древа специализации. Плюс – новый рейдовый бафф [Небесная ярость](https://www.wowhead.com/ru/spell=462854/), что резко повышает ценность Шамана в любой группе. 

[Тотем духовной связи](https://www.wowhead.com/ru/spell=98008) с талантом [Духовный подъем](https://www.wowhead.com/ru/spell=462383) станет полезнее в качестве рейдового сейва, так как будет давать более сильное снижение получаемого урона чем раньше. Плюс [Тотем целительного прилива](https://www.wowhead.com/ru/spell=108280/) станет сильнее в Мифик+ и группах малого размера.
...
Удаление [Хранителя бурь](https://www.wowhead.com/ru/spell=383009/) и переработка [Ливневого дождя](https://www.wowhead.com/ru/spell=462486/) поможет избавиться от лишних кнопок на панели, при этом можно будет раскидывать меньше [Огненных шоков](https://www.wowhead.com/ru/spell=188389/) вручную за счет таланта [Властелин стихий](https://www.wowhead.com/ru/spell=462375).

Также в The War Within у Рестор Шамана возрастет польза [Исцеляющего всплеска](https://www.wowhead.com/ru/spell=8004/) – теперь он усиливается за счет талантов [Тотем волн духостранника](https://www.wowhead.com/ru/spell=404522), [Улучшенное оружие жизни земли](https://www.wowhead.com/ru/spell=382315/) и получает большее усиление от [Властелина стихий](https://www.wowhead.com/ru/spell=462375).
