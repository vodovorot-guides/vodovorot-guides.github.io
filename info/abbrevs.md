...
* **Filler, Филлер** – способность, которая не затрачивает ресурсы и используется когда более сильные способности недоступны.
* **Generator, Генератор** – способность, создающая ресурс. Часто является также **Филлером**.
