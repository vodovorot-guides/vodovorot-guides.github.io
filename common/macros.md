...
* @cursor – использование заклинание по области, на место в котором в данный момент находится курсор (доступно только для заклинаний с применением на область, например Землетрясение или Целительный ливень).
