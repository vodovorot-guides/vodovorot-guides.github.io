...
* Исцеляет три цели, первую на **210%** от силы заклинаний, вторую на **147%**, третью на **103%**, четвертую на **72%**.
...
* Наносит **1151.5WWW%** урона от силы заклинаний в **1** цель.
...
* Есть два вида зелья, которые восстанавливают ману. Они имеют общее время восстановления (**5** минут) с другими боевыми зельями:
...
* Не работает от тиков [Целительного ливня](https://ru.wowhead.com/spell=73920) или от любых других способностей – только те, что перечислены в списке выше.
...
* Время произнесения – **2** секунды.
* Изначально время произнесения составляет **2.5** секунды, но [Молния: Ранг 2](https://ru.wowhead.com/spell=318044) сокращает жто время на **0.5** секунд.
...
* Талант первого тира [Эхо стихий](https://ru.wowhead.com/spell=333919/) дает [Выбросу лавы](https://ru.wowhead.com/spell=51505) второй заряд, в результате чего время восстановления не теряется при проке [Волны лавы](https://ru.wowhead.com/spell=77756), а также сокращает [Выброс лавы](https://ru.wowhead.com/spell=51505) до **8** секунд вместо «**8** секунд + время произнесения + время реакции».
...
* Крайне полезная способность в Мифик+ для уничтожения [Взрывоопасныъ сфер](https://ru.wowhead.com/spell=240446) от соответствующего аффикса.
...
Проценты снижения получаемого урона высчитываются не все разом (например, **40%** + **40%**), а по порядку. То есть если вам наносится **1000** урона, то при активном [Астральном сдвиге](https://ru.wowhead.com/spell=108271) и стоя в радиусе [Тотема духовной связи](https://ru.wowhead.com/spell=98008) сначала посчитается первый сейв, **1000**-**40%**, что равняется **600** урона. Потом от **600** урона отнимается **10%**, то есть **600**-**10%**=**540**. Таким же образом считается снижение урона от Универсальности и внешние сейвы, например [Железная кора](https://ru.wowhead.com/spell=102342) Друида и другие подобные заклинания.
{: class="bordered"}
...
* Тип урона элементаля – <span style="color:#FFFFFF;font-size:1em;">**Физический**</span>.
...
* Проводник [Прирост жизненных сил](https://ru.wowhead.com/spell=337981?ilvl=252) увеличивает ваше здоровье на во время его действия, что превращает [Элементаля земли](https://ru.wowhead.com/spell=198103) в защитный кулдаун.
...
* Время восстановления – **8** секунд.
* Кулдаун запускается только в том случае, если было снят магический эффект или проклятие, иначе потратится только ГКД и мана.
...
<a href="https://ru.wowhead.com/spell=137039" target="blank" data-wh-icon-size="medium" >**Шаман - Исцеление**</a> – скрытая аура, используется как модификатор урона и затраты ресурсов для различных заклинаний.
