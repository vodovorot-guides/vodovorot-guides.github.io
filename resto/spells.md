...
* Длительность действия – **15** секунд, после чего тотем автоматически взрывается и выпускает отхил.
* Тотем можно активировать раньше, повторно нажав на кнопку способности.
...
* Лучший вариант зарядки тотема – использовать АоЕ-способности, например [Родник](https://ru.wowhead.com/spell=197995)
