...
Есть четыре основных аддона, которые подходят под эти требования, и которые пользуются наибольшей популярностью у игроков – **Cell**, **VuhDo**, **Grid2** и **ElvUI**.
...
[Cell](https://www.curseforge.com/wow/addons/cell) – достаточно новый, но успевший зарекомендовать себя аддон.
...
На YouTube можно также найти [множество гайдов](https://www.youtube.com/results?search_query=wow+cell) по его настройке.

Данный аддон будет полезен не только хилам, но может использоваться также и дамагерами и танками, а также Пробудителями в ветке Насыщение.

Имеет встроенные функции настройки кнопок мыши на заклинания, удобную систему отслеживания дебаффов и многое другое.
...
[Grid2](https://www.curseforge.com/wow/addons/grid2) является специализированным аддоном, который, в отличие от ElvUI, никак не взаимодействует с другими частями интерфейса. Он чуть сложнее в настройке, но разобравшись, вы сможете быстро менять и добавлять то, что необходимо.
