...
Также в ElvUI отсутствует функция назначения заклинаний на кнопки мыши и маусовер, так что придется использовать аддон [Clique](https://www.curseforge.com/wow/addons/clique) или макросы ([об этом далее](https://stormkeeper.ru/resto/raidframes.html#%D0%BC%D0%B0%D1%83%D1%81%D0%BE%D0%B2%D0%B5%D1%80-%D0%BC%D0%B0%D0%BA%D1%80%D0%BE%D1%81%D1%8B)). Ну и есть некоторые ограничения в настройках, например, вы не сможете сделать покраску фрейма в определенный цвет только для вашей абилки (например, {{ site.data.spells.riptide }}), изменение цвета коснется всех таких баффов (в т.ч. баффов других игроков).
...
Данный аддон не заменяет стандартные фреймы, а открывает возможность настроить и кастомизировать их, добавляя полезный функционал. 
## HealBot
