...
Первое, что следует запомнить – **все вторичные характеристики хороши**. Нет смысла упираться в одну стату, так как при наборе одной характеристики её полезность снижается. Лучше иметь всех статов по **200**, чем одну на **800**. 

**Интеллект** на данный момент – лучшая характристика, так как повышает весь отхил и растет от уровня предметов гораздо сильнее, чем вторичные статы. Поэтому собираемся в первую очередь в уровень предметов.
...
Все характеристики мультипликативно переменожаются согласно следующим формулам:
...
«DIminishing Returns» начинает снижать эффективость статов на 10% по достижению следующих значений:
...
* Заклинания лечения прямого действия вызывают срабатывания пассивки {{ site.data.spells.resurgence }}.
* **Лучшая характеристика для рейда**, так как дает и отличный отхил (что прежде всего), но так и повышает реген маны.
...
* Чем ниже здоровья у цели вашего исцеления, тем больше будет выгода от Искусности. Если у цели осталось **20%** здоровья, то Искусность будет работать на **80%** своей эффективности.
...
* Имеет коэффициент **3.0** на значение рейтинга, то есть **35** ед. Искуности повышают её значения не на **1%**, как например у Критического удара, а на **3%**.
* На сайте [WoWAnalyzer](https://wowanalyzer.com/) можно увидеть эффективность Искусности в конкретном бою.

# Итоги.

Все вторичные характеристики хороши, и вместо того, чтобы упарываться в один стат, одевайте наивысший уровень предмета и соблюдайте баланс.
