...
Великолепный универсальный талант, лучший выбор в этом тире для большинства ситуаций. Несколько важных моментов:
  * Собирает в том числе и избыточное исцеление.
  * Не собирает отхил от других тотемов, например {{ site.data.spells.htt }}.

Для максимальной эффективности старайтесь использовать все короткие кулдауны, такие как  Riptide и Healing Rain, до активации Cloudburst Totem. Используйте свои АОЕ-способности во время действия тотема, но держите в уме, что уход в оверхил для подпитки тотема до, собственно, получения группой урона не всегда оправдано. Также стоит помнить, что тотем выбирает своими целями раненых союзников, а значит его “взрыв” может быть использован как сильное бурст-исцеление танка при отсутствии других раненых игроков в группе. 
Выбор таланта  Echo of the Elements во втором тире дает  Cloudburst Totem второй заряд и упрощает его использование и позволяет лучше готовиться сложным моментам в рейдах и м+. 
На данный момент это самый популярный выбор в 6 тире для любого контента.
