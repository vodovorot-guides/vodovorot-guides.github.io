---
title: Легендарные силы – Шаман Исцеление
layout: page
...
{{ site.data.legend.earth }} – достаточно ситуативная легендарка. Если здоровье танка (на которого обычно вешается {{ site.data.spells.eshield }}) часто падает ниже 50%, то скорее всего эта легендарка там уже не поможет. Может найти применение в ПвП. Увеличение количества зарядов работает только если вы применяете {{ site.data.spells.hw }} на цель под {{ site.data.spells.eshield }}.  
