...
**{{ site.data.legend.jonat }}** – {{ site.data.spells.hw }} и {{ site.data.spells.hs }} увеличивают исцеление следующего {{ site.data.spells.ch }} на **20%**, стакается **5** раз.
...
**{{ site.data.legend.mtt }}** – после использования {{ site.data.spells.mtt }} дает бафф на **10** секунд, который сокращает время применения {{ site.data.spells.hw }} и {{ site.data.spells.ch }} на **50%** и их стоимость маны на **40%**.
