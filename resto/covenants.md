...
* Лучшие показатели отхила в рейде, к тому же перекрывает главный минус Шамана Исцеления – отхил разрозненных целей.

* Пригодится также и для отхила танка, так как в него войдет сразу две {{ site.data.spells.hw }}.
