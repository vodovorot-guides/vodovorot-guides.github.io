...
* Кулдаун на срабатываение леги завязан на дебафф на персонаже, который сбрасывается смертью. Можно абузить через {{ site.data.spells.rez }}.
...
* Данная легендарка больше ориентирована на бой против одной цели.
