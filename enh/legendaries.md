...
* Специальные «силы» для легендарки, например {{ site.data.legend.reminder_item }}, выбиваются из различного типа контента – Рейд, Подземелья, Мировые боссы, ПвП. Шанс на выпадение, тем выше, чем дольше кулдаун активности. Например с мировых боссов он будет составлять **100%**, а с боссов подземелий – меньше.
