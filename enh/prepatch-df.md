...
Несмотря на то, что в целом система талантов Dragonflight поддталкивает к использованию <span style="color:#FFFFFF;font-size:1em;">**физического**</span> билда, в препатче не хватит талантов для полной реализации его потенциала. Лучше всего этот билд раскроет себя после релиза, когда в ветке специализации будет доступно на **25** талантов, а **30**.
{: class="bordered"}
