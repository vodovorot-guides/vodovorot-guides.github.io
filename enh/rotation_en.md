...
* German version of this page is [here](https://stormkeeper.ru/enh/rotation_de.html).
...
1. {:.pw-apl}[Lightning Bolt](https://www.wowhead.com/spell=188196) with the [Primordial Wave](https://www.wowhead.com/spell=326059) buff and **5+** [Maelstrom Weapon](https://www.wowhead.com/spell=187880) stacks.
...
* {:.hh-apl}During the [Hot Hand](https://www.wowhead.com/spell=201900) buff **always** alternate [Lava Lash](https://www.wowhead.com/spell=60103) and the next highest priority ability.  [Lava Lash's](https://www.wowhead.com/spell=60103) cooldown with this buff is equal two GCD’s, no matter how much haste you have. The exception is Urh buff in Mythic+, when you can just spam [Lava Lash](https://www.wowhead.com/spell=60103) with no CD.
* {:.hh-apl .actuators-apl .pw-apl}If you get **50-60%** Haste from [Splintered Elements](https://www.wowhead.com/spell=354647) legendary and targets under [Flame Shock](https://www.wowhead.com/spell=188389) are still alive along with the [Hot Hand](https://www.wowhead.com/spell=201900) buff, you can also spam [Lava Lash](https://www.wowhead.com/spell=60103) in a row without an GCD. This is possible due to the large amount of Haste and the effect of the lore legendary [Primal Lava Actuators](https://www.wowhead.com/spell=335895/).
