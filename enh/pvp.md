...
wow: 10.1
toc: true
author: "Shadi_eu, Amani"
description: PvP-гайд по Энх Шаману. Разобраны основные аспекты игры – выбор расы, талантов, характеристик, а также геймплейные советы, рекомендации по сетапам, аддоны и макросы и многое другое. Автор – Shadi_eu, гладиатор с опытом арены 3200+.
...
Данный гайд написан **Shadi_eu**, знатоком Энх Шамана и гладиатором с опытом арены **3200**+. Заглядывайте на [Twitch](https://www.twitch.tv/shadi_eu), [YouTube](https://www.youtube.com/@SHADIEU) и в [Discord-канале](https://discord.gg/EtY2PGsjun).
{: class="bordered"}
...
Версия <span style="color:#FFFFFF;font-size:1em;">**Физического**</span> билда, с талантами для переноса [Тотема статического поля](https://www.wowhead.com/ru/spell=355580), а так же вражеских игроков внутри него.
...
* С помошью PvP таланта [Тотем статического поля](https://www.wowhead.com/ru/spell=355580) и переносом его с помошью [Проецирование тотемов](https://www.wowhead.com/ru/spell=108287) мы можем переносить мобильные классы к нам в мили рендж.


## Выбор PvP Tалантов

* Постоянным и несменяемым талантом является [Тотем заземления](https://www.wowhead.com/ru/spell=204336). Он используется для поглощения магического урона, такого как [Возгорание](https://www.wowhead.com/ru/spell=190319), [Cтрела хаоса](https://www.wowhead.com/ru/spell=116858) и подобных. Также для поглощения входящего контроля по сюзникам – [Замораживающая ловушка](https://www.wowhead.com/ru/spell=187650), [Превращение](https://www.wowhead.com/ru/spell=118), [Безмолвие](https://www.wowhead.com/ru/spell=15487), [Смерч](https://www.wowhead.com/ru/spell=33786) и подобных.

* Вторым очень важным для выживания талантом является [Закапывание](https://www.wowhead.com/ru/spell=411370). Используем когда ваш хил получил долгий контроль, для избежания получения урона. Его также можно использовать в ситуациях, когда у вас слишком малый запас здоровья и вам ничего не остается как закопаться, чтобы дать немного времени для хилера вас исцелить.

* Третий выбор PvP таланта ситуативный. Чаще всего используется [Шаманство](https://www.wowhead.com/ru/spell=193876), но можно заменить его на [Тотем статического поля](https://www.wowhead.com/ru/spell=355580) против труднодосягаемых целей. Также можно взять талант [Оседлать молнию](https://www.wowhead.com/ru/spell=289874), для повышения урона в ситуациях, когда против вас команда с большим количеством питомцев (БМ Охотники, Варлоки Демонологи, Рыцари Смерти).

* [Ткач бури](https://www.wowhead.com/ru/spell=410673) является не лучшим вариантом для PvP-таланта, так как отхил от [Цепного исцеления](https://www.wowhead.com/ru/spell=1064) и [Исцеляющего всплеска](https://www.wowhead.com/ru/spell=8004) на арене слишком низко. Основное лечение в сражениях на арене сейчас идет за счет [Щита земли](https://www.wowhead.com/ru/spell=974) и [Тотема исцеляющего потока](https://www.wowhead.com/ru/spell=5394), которые желательно постоянно поддерживать на себе и союзниках.
...
* **Если [Удар Бури](https://www.wowhead.com/ru/spell=17364) и [Сокрушающая молния](https://www.wowhead.com/ru/spell=187874) недоступна, а зарядов [Оружия Водоворота](https://ru.wowhead.com/spell=187880) на [Молнию](https://www.wowhead.com/ru/spell=188196/) нет, используйте [Ледяной клинок](https://www.wowhead.com/ru/spell=342240)** что бы избежать простоев в ротации. Эта способность позвоялет вызвать срабатывание [Оружия неистовства ветра](https://ru.wowhead.com/spell=33757/) и [Вестника шторма](https://www.wowhead.com/ru/spell=201845/).
...
* Макрос который позволяет прерывать заклинания с помощью [Пронизывающего ветра](https://www.wowhead.com/ru/spell=57994/) по Арена фреймам. Необходимо сделать таких **3** таких макроса под каждый фрейм (arena1, arena2, arena3):
~~~
#showtooltip 
/stopcasting
...
* Макрос с модификатором для бафа [Шитов земли](https://www.wowhead.com/ru/spell=974) по фреймам Группы с помошью Аддона **Frame Sort**:
~~~
...
* Макрос для PvP способности [Закапывание](https://www.wowhead.com/ru/spell=411370) с Cancelaura что бы можно было выкопаться в любой момент:
~~~
...
* Макрос для [Сглаза](https://www.wowhead.com/ru/spell=51514) по Арена фреймам. Необходимо сделать таких **3** таких макроса под каждый фрейм (arena1, arena2, arena3):
~~~
...
* Макрос на [Астральный сдвиг](https://www.wowhead.com/ru/spell=108271) и [Наставления предков](https://www.wowhead.com/ru/spell=108281). Пригодится в ситуациях, когда вас бурстят оппоненты и вам нужно хилить себя и команду, пасивно нанося урон:
~~~
#showtooltip
/stopcasting
...
## Приоритет выбора целей и фишки против классов

Приоритет выбора целей во втором сезоне Dragonflight, а также ключевые действия против них для Энх Шамана:
...
{% include button.html name="Twitch канал автора – Shadi_eu" link="https://www.twitch.tv/shadi_eu" %}  
