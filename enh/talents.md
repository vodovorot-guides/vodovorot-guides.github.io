...
* **35 уровень:** {{ site.data.spells.hailstorm }} отличный выбор для Мифик+, дает больше урона на АоЕ, но хуже в бою против одной цели. Однако чем выше ваш уровень предметов, тем эффективнее себя показывает [Атака стихий](https://ru.wowhead.com/spell=17364).

* **40 уровень:** Тир ситуативных талантов, выбирайте по вашему усмотрению.

Несмотря на то, что в патче **9.0.5** появилась возможность играть через легендарку [Волчьи кости колдуна](https://ru.wowhead.com/spell=335897) с талантами {{ site.data.spells.eb }}, {{ site.data.spells.hh }} и {{ site.data.spells.spirits }}, данный билд крайне рандомен в СТ и слаб на АоЕ, поэтому не рекомендуется к использованию в контенте высокой сложности.
{: class="bordered"}
