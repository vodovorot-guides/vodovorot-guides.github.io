...
{{ site.data.spells.lf }} – пассивный талант, {{ site.data.spells.ll }} увеличивает урон от {{ site.data.spells.fs }} на одной цели на **100%** на **20** секунд.
...
{{ site.data.spells.fw }} – пассивный талант, каждое срабатывание [Оружия неистовства ветра](https://ru.wowhead.com/spell=33757) увеличивает его урон на **35%** на **15** секунд, стакается **5** раз. При получении эффекта время действия не обновляется.
...
{{ site.data.spells.eb }} – активная способность, наносит урон одной цели и дает бафф к случайной характеристике. Кулдаун **12** секунд.
...
{{ site.data.spells.flurry }} – пассивный талант, {{ site.data.spells.ss }} с шансом **25%** поразит цель еще раз, нанося **40%** от обычного урона. Этот эффект может срабатывать сам от себя.
...
{{ site.data.spells.hh }} – пассивный талант, ваши **автоатаки** с [Оружием языка пламени](https://ru.wowhead.com/spell=318038) имеют **5%** шанс дать бафф на **8** секунд, который увеличивает урон от [Вскипания лавы](https://ru.wowhead.com/spell=60103) на **100%** и снижает его кулдаун на **75%**.

* **На данный момент этот талант не используется.**

{{ site.data.spells.is }} – активная способность, наносит средний урон и сбрасывает время восстановления [Огненного шока](https://ru.wowhead.com/spell=188389) и [Ледяного шока](https://ru.wowhead.com/spell=196840). Время восстановления **15** секунд, сокращается Скоростью.
...
{{ site.data.spells.eshield }} – активная способность, накладывает щит, который лечит цель при получении урона. Имеет **9** зарядов, после чего его следует обновлять.
...
{{ site.data.spells.ea }} – пассивный талант, увеличивает урон от [Удара бури](https://ru.wowhead.com/spell=17364) на **15%** и он дает **1** гарантированный стак [Оружия Водоворота](https://ru.wowhead.com/spell=187880).
...
{{ site.data.spells.hailstorm }} – пассивный талант, при трате стаков [Оружия Водоворота](https://ru.wowhead.com/spell=187880) вы получаете бафф, который увеличивает урон [Ледяного шока](https://ru.wowhead.com/spell=196840) на **15%** и он поражает одну дополнительную цель за каждый стак.
...
{{ site.data.spells.fn }} – активная способность, каждая цель под [Огненным шоком](https://ru.wowhead.com/spell=188389) наносит небольшой урон **6** противникам (плюс основной цели) в радиусе **8** метров.
...
{{ site.data.spells.fl }} – активная способность, «чардж» к противнику на расстоянии **8-25** метров. Наносит незначительный урон и имеет время восстановления **30** секунд.
...
{{ site.data.spells.wrt }} – активная способность, вы устанавливаете тотем в указанном месте, увеличивающий скорость передвижения любого союзника, зашедшего в зону его действия, на **60%** в течение **5** секунд.
...
{{ site.data.spells.sunder }} – активная способность, наносит АоЕ урон перед вами и дезориентирует врагов на **2** секунды. Время восстановления **40** секунд.
...
{{ site.data.spells.spirits }} – пассивный талант, усиливает наш «бурст» {{ site.data.spells.feral }}, сокращая его кулдаун на **30** секунд и дает один из случайных баффов каждому волку:
...
{{ site.data.spells.spike }} – активная способность, наносит одной цели физический урон и увеличивает наносимый вами физический урон и урон от сил природы по этой цели на **20%** на **10** секунд.
