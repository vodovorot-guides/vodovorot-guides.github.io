...
{{ site.data.covenants.pw }} – поражает одну цель, нанося небольшой урон противнику и накладывая на него {{ site.data.spells.fs }}. Применяется мгновенно. Время восстановления 45 сек. Следующая {{ site.data.spells.lb }} также применится ко всем целям под {{ site.data.spells.fs }}.
...
* Урон от этой способности усиливается от Искусности {{ site.data.spells.enh_mastery }}.  
