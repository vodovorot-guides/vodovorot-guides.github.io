...
• {{ site.data.spells.lava_surge }} – в [официальных патчноутах](https://worldofwarcraft.com/en-us/news/23529209/shadowlands-pre-expansion-patch-notes) можно увидеть, что шанс срабатывания понижен с **15%** до **10%**. Мы не знаем, ошибка это (потому что в тех патчноутах много косяков), так задумано для Shadowlands (на Бете этого нет) или это только для препатча, как компенсация Азеритового трейта {{ site.data.spells.potential }}, который помимо увеличения урона от {{ site.data.spells.lvb }} также увеличивает шанс прока {{ site.data.spells.lava_surge }} на 3%.
