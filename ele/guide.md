...
<iframe title="Talent Embed Example 1" src="https://www.raidbots.com/simbot/render/talents/CYQAAAAAAAAAAAAAAAAAAAAAAAAAAAAYb2WmZmZGz2sMGMMDDAAAAAYzMG2gFYGN0YDAMbTzgxGjZaYmZGzYZGzYxsMWsYmZmxwMbDA?width=700&bgcolor=262b39&locale=ru_RU" width="100%" height="400px" style="overflow: hidden"></iframe>

<p></p>

* На данный момент билд является предварительным и будет изменен после старта сезона.
...
2. [Хранитель бурь](https://ru.wowhead.com/spell=191634) за **4** секунды до пула.
...
* В ветке **Предсказателя** [Тотем жидкой магмы](https://ru.wowhead.com/spell=192222) нужно использовать таким образом, чтобы его применение совпало с максимальным количеством предков в бою. Дело в том, что [Тотем жидкой магмы](https://ru.wowhead.com/spell=192222) вызывает срабатывание сразу двух кастов от предков – один за счет АоЕ от самого тотема, и второй за счет наложения [Огненного шока](https://ru.wowhead.com/spell=188389).

* В идеале нужно следовать следующей ротацией каждые **30/60** секунд:
...
В рейде Манагорн Омега выпадают оружия с особым эффектом:
* [Крис из стекла бездны](https://www.wowhead.com/ru/item=237728/%D0%BA%D1%80%D0%B8%D1%81-%D0%B8%D0%B7-%D1%81%D1%82%D0%B5%D0%BA%D0%BB%D0%B0-%D0%B1%D0%B5%D0%B7%D0%B4%D0%BD%D1%8B?bonus=7981:12052:5877:12361) – является лучшим оружием за счет прока урона и щита, при этом имеют полный бюджет характеристик. Позволяет использовать щит или крафтовый предмет для левой руки с украшением
