...
<div class="btn-toolbar justify-content-center mt-2 mb-3">
  <div class = "btn-group btn-group-sm">
    <button type="button" id="target_1" class="btn btn-primary px-3 rotation-btn">1-2 цели</button>
...
* В приоритетах выше есть переключатель **Активировать пнутый приоритет**, который показывает более сложный, но более эффективный вариант приоритетов на АоЕ. Разница между упрощенным приоритетом примерно в **5-7%** урона.
