...
<a href="https://ru.wowhead.com/spell=198067" target="blank" data-wh-icon-size="medium" >**Элементаль огня**</a> – базовый «бурст» с кулдауном **2.5** минут.
...
* При активации способности призывается 
...
* [Огненный взрыв](https://ru.wowhead.com/spell=57984/) – основная атака по одной цели, наносит **67.5%** урона от силы заклинаний. Базовое время произнесения **3** секунды. Кастуется элементалем автоматически.
