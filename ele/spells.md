...
* Применяется мгновенно, считается заклинанием магии <span style="color:#f16f25;font-size:1em;">**Огня**</span> и стоит **5%** маны.
...
* По умолчанию, если цель находится дальше **40** метров от персонажа, то [Элементаля огня](https://ru.wowhead.com/spell=198067) не призовется. Это можно обойти с помощью следующего макроса:
```
#showtooltip
/cast [@player] Элементаль огня
```
* [Элементаль огня](https://ru.wowhead.com/spell=198067) достаточно слабый бурст, особенно если сравнить с другими классами, например [Возгорание](https://ru.wowhead.com/spell=190319) Мага или [Дикие духи](https://ru.wowhead.com/spell=328231) Охотника.
...
не ускоряет тики, не удлиняет шоки
проводник
...
<a href="https://ru.wowhead.com/spell=108271" target="blank" data-wh-icon-size="medium" >**Астральный сдвиг**</a> – основной сейв, снижает весь получаемый урон на **40%** на **12** секунд.
