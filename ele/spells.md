...
<a href="https://ru.wowhead.com/spell=168534" target="blank" data-wh-icon-size="medium" >**Искусность: волнение стихий**</a> – дает некоторым заклинаниям поразить цель повторно, нанеся меньше урона и давая меньше энергии Водоворота.

> Перегрузка

* Урон при проке перегрузки снижен до **85%** от базового.
