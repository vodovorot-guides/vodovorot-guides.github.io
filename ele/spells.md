...
* Помимо обычной атаки, [Элементаль огня](https://ru.wowhead.com/spell=198067) также усиливает заклинание [Огненный шок](https://ru.wowhead.com/spell=188389):
  * Время между тиками сокращено на **25%**, вместо базовых **2** секунд оно составляет **1.5** секунд.
...
* Базовая длительность [Элементаля огня](https://ru.wowhead.com/spell=198067) составляет **30** секунд, 
ускоряет тики на 25%
удлиняет новые шоки
не трогает наложенные шоки
проводник
усиливается хастой, критом и версой, но не иск
макрос
ренж
слабый бурст, лучше всего показывает себя в бою против 2-3 целей
усиливается талантом
