...
* [Ссылка на билд в калькуляторе талантов Wowhead](https://www.wowhead.com/beta/talent-calc/shaman/elemental/DANBFVBUFFFYoEgBCEAMVVFFQVCoQYABDQQA)
* Код для импорта талантов в игре:
~~~
...
Альтернатива этому билду без легендарки [Равновесия стихий](https://www.wowhead.com/ptr/spell=336730/) – [по этой ссылке](https://www.wowhead.com/ptr/talent-calc/shaman/elemental/DANBFVBUFFFYoEgBCEAMVVFFQVCoQCABCQQ). В этом случае используется лега [Отголоски Великого Раскола](https://www.wowhead.com/ru/spell=336215/), но на [Удар духов стихий](https://www.wowhead.com/ptr/spell=117014) легендарка не работает, только на одноименный талант.
{: class="bordered"}
