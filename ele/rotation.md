...
2. Кастуйте {{ site.data.spells.lvb }} только по проку от [Волны лавы](https://ru.wowhead.com/spell=77756) и только перед [Землетрясением](https://ru.wowhead.com/spell=61882), либо во время движения.
3. Поддерживайте {{ site.data.spells.fs }} на самых живучих врагах.
