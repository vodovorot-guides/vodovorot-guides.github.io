...
Рассмотрим самые эффективные PvP-таланты Элем Шамана. Все другие варианты, не перечисленные ниже, практически не используются.
...
<a href="https://ru.wowhead.com/spell=204330" target="blank" data-wh-icon-size="medium" >**Тотем небесной ярости**</a> – увеличивает критический урон союзников на **20%**.
...
<a href="https://ru.wowhead.com/spell=204403" target="blank" data-wh-icon-size="medium" >**Блуждающие бури**</a> – позволяет применять способность [Гром и молния](https://ru.wowhead.com/spell=204406) к союзником и сокращает время восстановления на **15** секунд.
...
* **Критический удар** ощутимо увеличивает эффективность [Земного шока] и [Хранителя бурь], но никак не влияет на [Выброс лавы]
...
**Элем + Рестор Друид** – слабее предыдущего сетапа, но всё таки достаточно сильный ваириант. Много контроля от друида и ассист уроном, слаб против команд с двумя пурджами.
...
**Элем + Фаер Маг + Хилер** – самый сильный сетап на данный момент. Огромный урон от Мага во время [Возгорания](https://ru.wowhead.com/spell=190319) под вашим [Тотемом небесной ярости](https://ru.wowhead.com/spell=204330), можно убить буквально за пару ГКД. Тяжело против Турбо-клива и Джангл-клива, с остальными сетапами проблем нет. Из хилов подойдет Паладин, Друид или Прист. Для игры в этом сетапе требуется коммуникация.
