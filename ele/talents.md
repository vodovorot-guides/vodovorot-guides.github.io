...
* **45 уровень:** Если вам сложно не терять стаки [Ледяной ярости](https://ru.wowhead.com/spell=210714) и уследить за всеми КД, используйте талант {{ site.data.spells.primal_elem }}, потери ДПС будут не критичны.
...
* **35 уровень:** Выбор между [Властелином стихий](https://ru.wowhead.com/spell=16166) и [Элементалем бури](https://ru.wowhead.com/spell=192249/) зависит от аффиксов и уровня ключа. Чем толще мобы, тем больше будет пользы от [Элементалем бури](https://ru.wowhead.com/spell=192249/). Для низких ключей или на тиранических неделях, когда паки умирают достаточно быстро, лучше брать талант [Властелин стихий](https://ru.wowhead.com/spell=16166).
...
* **Отличный и универсальный талант.**
...
* В бою против одной цели проигрывает [Удару духов стихий](https://ru.wowhead.com/spell=117014/).
...
* На **4+** целях этот талант практически бесполезен.
* Усиливается талантом {{ site.data.spells.mote }}.
* Генерирует достаточно много энергии Водоворота, что отлично сочетается с нашими легендарками {{ site.data.legend.lava }} и {{ site.data.legend.eogs }}, но на АоЕ проигрывает [Повторному толчку](https://ru.wowhead.com/spell=273221).
* Более подробное описание можно найти [здесь](https://stormkeeper.ru/ele/spells.html#%D0%B1%D0%BE%D0%B9-%D0%BF%D1%80%D0%BE%D1%82%D0%B8%D0%B2-%D0%BE%D0%B4%D0%BD%D0%BE%D0%B9-%D1%86%D0%B5%D0%BB%D0%B8).
...
* **Используется в основном в PvP, в PvE применяется крайне редко.**
...
* Подробности про ротацию с этим талантом можно найти [здесь](https://stormkeeper.ru/ele/rotation.html).
...
* Используется только в сочетании с талантом шестого тира – {{ site.data.spells.primal_elem }}, что превращает его в отличную бурст, особенно на АоЕ.
...
* Узнать про ротацию во время активного [Элементаля бури](https://ru.wowhead.com/spell=192249) можно [по этой ссылке](https://stormkeeper.ru/ele/rotation.html).
...
* **Неплохой талант для Мифик+, отлично хилит на АоЕ.**
...
* Более подробное описание можно найти [здесь](https://stormkeeper.ru/ele/spells.html#%D0%B2%D1%81%D0%BF%D0%BE%D0%BC%D0%BE%D0%B3%D0%B0%D1%82%D0%B5%D0%BB%D1%8C%D0%BD%D1%8B%D0%B5-%D1%81%D0%BF%D0%BE%D1%81%D0%BE%D0%B1%D0%BD%D0%BE%D1%81%D1%82%D0%B8).
...
* Узнать про ротацию с этим талантом можно [здесь](https://stormkeeper.ru/ele/rotation.html).
* Более подробное описание можно найти [здесь](https://stormkeeper.ru/ele/spells.html#%D0%B1%D0%BE%D0%B9-%D0%BF%D1%80%D0%BE%D1%82%D0%B8%D0%B2-%D0%BE%D0%B4%D0%BD%D0%BE%D0%B9-%D1%86%D0%B5%D0%BB%D0%B8).
