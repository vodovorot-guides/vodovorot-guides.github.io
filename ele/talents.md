...
* На **1-2** цели следует использовать [Молнию](https://ru.wowhead.com/spell=188196), а на **3+** уже [Цепную молнию](https://ru.wowhead.com/spell=188443), как

{{ site.data.spells.asc_ele }} – 
