...
1. {{ site.data.spells.lb }} в **одну** цель дает **11** энергии Водоворота и наносит **439.3%** урона от силы заклинаний.
2. {{ site.data.spells.cl }} в **две** цели дает **20** энергии Водоворота и наносит **253.8%** урона от силы заклинаний (именно поэтому следует использовать усиленную [Молнию](https://ru.wowhead.com/spell=188196) на две цели).
3. {{ site.data.spells.lb }} в **три** цели дает **36** энергии Водоворота и наносит **500.55%** урона от силы заклинаний.
4. {{ site.data.spells.lb }} в **четыре** цели дает **64** энергии Водоворота и наносит **827.2%** урона от силы заклинаний.
5. {{ site.data.spells.lb }} в **пять** целей дает **95** энергии Водоворота и наносит **1233.75%** урона от силы заклинаний. 
