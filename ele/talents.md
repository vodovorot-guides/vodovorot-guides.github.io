...
* Подробно узнать про ротацию во время активного [Элементаля бури](https://ru.wowhead.com/spell=192249) можно [по этой ссылке](https://stormkeeper.ru/ele/rotation.html).
