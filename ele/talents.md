...
3. {{ site.data.spells.cl }} по **3** целям дает **36** энергии Водоворота и наносит **500.55%** урона от силы заклинаний.
...
* Для сравнения: {{ site.data.spells.quake }} в одну цель наносит **138%** урона от силы заклинаний, то есть **690%** урона от силы заклинаний по **пяти** целям.
