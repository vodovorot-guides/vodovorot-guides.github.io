...
* Копия Искусности из **Warlods of Draenor**.
...
{{ site.data.spells.eb }} – активная способность с коротким кулдауном, наносит средний урон и дает случайный бафф к случайной характеристике, а так же генерирует Энергию Водоворота.
...
* {{ site.data.spells.lb }} – добавляет дополнительные эффекты перегрузки, как при срабатывании Искусности {{ site.data.spells.elem_mastery }}.
  ...
  * Не зависит от стандартного шанса перегрузки от Искусности, вероятность на его прок обсчитывается отдельно. 
