...
* В тексте ниже не рассмотрены медиумы, которые не доступны до максимальной прокачки ковенанта (приблизительном Март 2021 года). Статья будет дополнена ближе к делу.
...
* {{ site.data.conduits.wave }} – проводник, усиливающий эту способность. Дает шанс сбросить кулдаун {{ site.data.covenants.pw }} при её использовании. Подробнее про проводники по [в этом разделе](https://stormkeeper.ru/ele/conduits.html).
...
* Работает на **3** атакующие и **3** хилящие способности, количество исопльзований никак не связано между собой.
...
* {{ site.data.conduits.harvest }} – проводник, усиливающий эту способность. Увеличение шанса Критического удара как поднимает урон, так и потенциально снижает кулдаун {{ site.data.covenants.ch }}. Проводник практически в бою против одной цели. 
...
* Облик души имеет **24** различных облика, которые открываются по мере прокачки ковенанта. Подробности можно узнать [по этой ссылке](https://www.noob-club.ru/index.php?topic=63075.0).
