---
title: Обзор Ковенантов – Элем Шаман
layout: page
...
{{ site.data.covenants.pw }} — поражает одну цель, нанося небольшой урон противнику и накладывая на него {{ site.data.spells.fs }}. Применяется мгновенно. Время восстановления 45 сек. Ваш следующий {{ site.data.spells.lvb }} также применится ко всем целям под {{ site.data.spells.fs }} c 80% эффективностью.
