...
Во вкладке **«Character»** можно увидеть информацию о вашем персонаже, но самая полезная инфа находится чуть ниже. Это раздел **«Similar kill times»**, где показаны **10** логов с похожим временем боя, что очень удобно для сравнения. К сравнению с другими Элем шаманами мы еще вернемся.
...
«Неправильный подбор характеристик» – часто первое, что думают новички, когда пытаются определить где они теряют ДПС. Однако, **нет никаких магических соотношений статов, после которых вы станете дпсить лучше всех**. Нет никаких капов, брейкпоинтов и прочих цифр, к которым следует стремиться. Фактически вообще не стоит забивать себе голову характеристиками и их количеством, за вас все сделает [Raidbots](https://www.raidbots.com/simbot). 
...
А вот вкладку **Stat Weights** **НЕ СТОИТ ИСПОЛЬЗОВАТЬ НИ ПРИ КАКИХ ОБСТОЯТЕЛЬСТВАХ!** Данный модуль очень устарел, так как сейчас есть гораздо более точные методы проверки того, какой стат апнет вас больше всего. При симе **Stat Weights** по очереди накидывается по **~100** ед. каждой характеристики, и исходя из полученных данных формируется результат. Это крайне не точная информация, так как при повышении одной характеристики у нас меняется приоритет других статов, а **Stat Weights** не способен это отслеживать.

Чтобы узнать какие чанты и камни стоит использовать, используйте **Top Gear**.
Чтобы узнать, какой гир следует фармить – **Droptimizer**.

Во вкладке **Top Gear**, обратите внимание на настройки Сима, внизу страницы. **Simulation Options** позволяет кастомизировать множество параметров:
...
СИМКРАФТ НЕ ДЛЯ ПРОВЕРКИ УРОНА, А ДЛЯ СРАВНЕНИЯ ВЕЩЕЙ
