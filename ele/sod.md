...
* Крайне рекомендуется сделать макрос на выбор босса, так как в этом бою часто будет спадать цель. Назначьте его на комбинацию клавиш типа **Ctrl+Tab**, чтобы сразу выедлять Сильвану при её касте [Завесы тьмы](https://ru.wowhead.com/spell=347704/):
~~~
/target boss1
~~~
...
* [Элементаль огня](https://ru.wowhead.com/spell=198067) используется с пула и по КД
...
* На первых аддах на второй фазе сдавайте только [Хранитель бурь](https://ru.wowhead.com/spell=191634), все остальные бурсты оставьте на момент боя с Сильваной после второго моста. Сдавать его стоит на сразу, а после того, как призовутся сферы.
...
* Сбивайте каст [Жуткой сфере](https://ru.wowhead.com/spell=356023), которую призывает один из аддов. Для этого можно использовать макрос:
~~~
#showtooltip
/target Жуткая сфера
...
* Призывайте на этих аддах [Элементаля земли](https://ru.wowhead.com/spell=198103/) ради дополнительного здоровья от проводника [Прирост жизненных сил](https://ru.wowhead.com/spell=337981/). Это самый опасный момент второй фазы, где входит очень много урона.
* [Хранителя бурь](https://ru.wowhead.com/spell=191634) стоит использовать сразу по КД, когда будете бить Сильвану второй раз на этой фазе. 

__Третья фаза:__
* Все бурсты на этой фазе используются по КД.
* [Элементаль огня](https://ru.wowhead.com/spell=198067) можно будет использовать три раза за фазу, причем один из них под [Жажду крови](https://ru.wowhead.com/spell=2825/).
