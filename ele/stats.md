...
* Например, с **18%** Скорости {{ site.data.spells.lvb }} кастуется **1,694915254237288** секунд, а с **19%** Скорости {{ site.data.spells.lvb }} кастуется **1,680672268907563** секунд. Однако в игре, если прочитать подсказку заклинания, с обоими значеними вы увидите время произнесения **1.6** секунд.
