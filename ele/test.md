...
В этом билде падает ценность **Критического удара**, так как [Выброс лавы](https://ru.wowhead.com/spell=51505) критует со **100%** шансом и занимает примерно **30-40%** от всего урона за ключ. Но он все еще полезен, так как остальные **60-70%** урона всё еще скейлится от крита.
