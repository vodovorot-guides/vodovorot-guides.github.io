...
* Среднее время прокачки для первого персонажа занимает **5-7** часов, если выполнять только сюжетные квесты (и пару второстепенных заданий для профессий). Это с  учетом перерывов и открытия всех талантов полетов на драконах.
* Вы получите первого дракона примерно через час после начала прокачки. Остальные три дракона получаются по ходу кампании.
* Вы можете менять таланты персонажа по ходу прокачки если вас не устраивает ваш билд.
...
* Нет смысла ходить в подземелья на прокачке, так как будет трата времени. Вы можете качать второго персонажа только в подземельях, так как ему не будет необходимости закрывать сюжетные квесты для открытия локальных и еженедельных заданий.
...
* Если вы планируете качать добыающую профессию на **70** уровне, то имеет смысл собирать ресурсы на прокачке.
...
* Экипировкас с квестов может прокнуть на дополнительный уровень предмета.
* С первых квестов дают экипировку **~230** ilvl.
...
* Для открытия талантов полетов на драконах необходимо собирать специальные глифы, которые расбросаны по всей территории Драконьих Островов. 
...
* После установки [Handynotes](https://www.curseforge.com/wow/addons/handynotes) и [Handynotes Dragon Glyphs](https://www.curseforge.com/wow/addons/handynotes-dragon-glyphs) вы увидите на карте и миникарте отображение глифов. Для более удобного сбора рекомендуется летать по крате из картинки выше.
...
* Однако это ограничение можно обойти, зайди в инст самостоятельно, предварительно собрав группу в гильдии или через заранее собранные группы.
...
* Если вам не нравятся представленные ниже билды, то ничего не мешает вам изменить их под себя. Я прокачал на бете около **6** персонажей и данные варианты покзались мне самыми быстрыми и приятными на прокачке.
...
* Во время прокачки лучше всего себя показывают АоЕ заклинания, позволяющее уничтожить сразу большой пак мобов, такие как [Хранитель бурь](https://www.wowhead.com/ru/spell=191634) и [Тотем жидкой магмы](https://www.wowhead.com/spell=192222/).
...
* Можно собрать большую группу мобов на маунте, после чего призвать [Элементаля земли](https://www.wowhead.com/ru/spell=198103) чтобы он забрал на себя аггро.
...
* В отличе от [Огненного шока](https://ru.wowhead.com/spell=188389) и [Ледяного шока](https://www.wowhead.com/ru/spell=196840/) [Развеивание магии](https://www.wowhead.com/ru/spell=370/) не имеет кулдауна и не замедляет врагов, что очень полезно при сборе противников.
* Можно собрать большую группу мобов на маунте, после чего призвать [Элементаля земли](https://www.wowhead.com/ru/spell=198103) чтобы он забрал на себя аггро.
* Если вам лень обновлять на себе [Щит земли](https://www.wowhead.com/ru/spell=974/), то можно взять [Тотем исцеляющего потока](https://www.wowhead.com/ru/spell=5394) и ставить его после боя с паком.
* Используйте [Жажду крови](https://www.wowhead.com/ru/spell=2825/) / [Героизм](https://www.wowhead.com/ru/spell=32182) на прокачке по КД.
