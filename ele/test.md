...
* Для открытия рецепта необходимо прокачать навык професии минимум до **25** и открыть **Специализации**. После чего нужно прокачать нужную специализацию, соответствующую типу предмета. Например, специализация посохов для начертателей или специализация кольчужных нагрудников для кожевников.
...
* Ранг определяется прокачкой навыка профессии и качеством реагентов, используемых в рецепте. Для лучшего результата нужно брать лучшие (трехзвездочные) реагенты, а также использовать лучшие доступные инструменты професиии.
...
* [Изначальный хаос](https://www.wowhead.com/beta/item=190454) также требуется для высокоуровнего крафта, он получается за участвие в различном контенте – Мифик+, рейды, PvP.
...
* К любому крафтовому предмету можно добавить **Украшение**, но носить одновременно можно всего два предмета с украшениями. Они дают различные баффы и дополнительные свойсва, а некоторые предметы имеют встроенное украшение, для которого не нужен дополнительный реагент.
...
* За прокачку специализации алхимии можно получить перки, продлающие время действия флаконов в три раза, с **30** минут до **полутора часов**.
...
* Ювелиры изготавливают кольца, ожерелья, самоцветы, статуетки (дают баффы для открытого мира), аксессуары, игрушки и питомцев.
...
* Новые депеши, которые гарантируют определенные статы при крафте, теперь дают сразу две характеристики – например Скорость + Универсалость, Критический удар + Искусность и так далее.
* Фолиантов для смены талантов больше нет, потому что таланты можно свободно менять в любом месте вне боя.

**Начертание** в начале дополнения будет полезно для крафта Колод карт Новолуния, которые в Dragonflight прослужат дольше чем пре-рейдовый гир за счет увеличения их ilvl до эпохального уровня. Свитки характеристик будут полезны по ходу всего дополнения, так как они будут использоваться при крафте и рекрафте высокоуровнеых предметов. Но все, что предлагает Начертание, можно просто купить на аукционе в виде свитков или заказов, каких то особых перков в специализациях она не имеет.
{: class="bordered"}
...
* Кузнецы умеют делать расходуемые ремотные молоты, которые позволяют чинить снаряжение. Сейчас на бете молоты багнуты и не работают, но если вдруг окажется что они не тратятся при использовании или починка с их помощью будет стоить дешевле, чем чиниться у торговца, то кузнечное дело станет выгодно использовать для экономии золота на ремонте предметов.
