...
__Ответ:__ **Да**, профессия просто прокачается по ходу игры. Можно взять добывающие профессии (**Травничество**, **Горное дело**, Снятие** шкур**), либо профессии с пассивным доходом – **Наложение чар** (за счет распыления предметов) и **Портняжное дело** (за счет увеличенного дропа ткани).
