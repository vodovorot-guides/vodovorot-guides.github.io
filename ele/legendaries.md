...
**{{ site.data.legend.eogs }}** – после использования {{ site.data.spells.es }} увеличивает урон от следующего {{ site.data.spells.quake }} на **120%**.
...
**{{ site.data.legend.sefuz }}** – аналог легендарного кольца из Legion – {{ site.data.legend.leg_sephuz }}, но вместо бонусной скорости дает все вторичные характеристики.
* **Источник**: Покупается за очки чести.  
