...
* Всегда баффайте усиленное {{ site.data.spells.quake }} талантом {{ site.data.spells.mote }}, вне зависимости от количества целей, прока и оверкапа энергии Водоворот.
