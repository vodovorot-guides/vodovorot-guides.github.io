...
{{ site.data.legend.eogs }} – лучшая легендарка на АоЕ. Нам необходимо после {{ site.data.spells.es }} успеть набрать 60 ед. Энергии Водоворота за 15 секунд, чтобы использовать {{ site.data.spells.quake }}. 
