...
{{ site.data.legend.eogs }} – лучшая легендарка на АоЕ. После использования {{ site.data.spells.es }} необходимо успеть набрать 60 ед. Энергии Водоворота за 15 секунд, чтобы использовать усиленное {{ site.data.spells.quake }}. 
* Источник: Подземелье Та Сторона – Мве'зала. 
* Слоты: Плечо, Кисти рук.

{{ site.data.legend.fire }} – лучшая легендарка на кливе разрозненных целей. В бою против 3-4 целей, время восстановления {{ site.data.spells.fe }} сокращается до 50-60 секунд. Сочетается со способностью Некролордов {{ site.data.covenants.pw }} и с талантом {{ site.data.spells.primal_elem }}.
* Источник: Замок Нафрия – сир Денатрий. 
* Слоты: Грудь, Палец.

{{ site.data.legend.lava }} – лучшая легендарка в бою против одной цели. Дает прок {{ site.data.spells.lava_surge }} и усиливает {{ site.data.spells.lvb }} после каждого применения {{ site.data.spells.es }}.
* Источник: Мировой босс – Валинор. 
* Слоты: Ступни, Спина.

{{ site.data.legend.ee }} – эффект этой легендарки срабатывает от {{ site.data.spells.eb }} и {{ site.data.spells.ecs }}. На данный момент – одна из самых слабых легендарок.
